...
//register user
//************************************************************************************************************************* */
// function __hashPasswordAndRegisterError(res,err){
//   res.status(500).json({ message: err });

// }


// function __hashPasswordAndRegister(req,res,hashedPassword){
...
//   });
// }
// function __generateSaltError(res,err){
//   res.status(500).json({ message: err });

// }

// function _generateSalt(req,res,salt){
  
//   bcrypt.hash(req.body.password, salt, (err, hashedPassword) => );
  
// }
module.exports.registerUser = (req, res) => {
  // bcrypt.genSalt(10).then(__hashPasswordAndRegister.bind(null,req,res)).catch(__generateSaltError.bind(null,res));
